...
from coinem.maximisation_step import ImportanceWeight
...
def importance_svgd(
    ...
    return expectation_maximisation(
        expectation_step=SteinExpectationStep(model=model, optimiser=latent_optimiser),
        maximisation_step=ImportanceWeight(model=model, optimiser=theta_optimiser),
        data=data,
        latent_init=latent_init,
        theta_init=theta_init,
        max_time=max_time,
